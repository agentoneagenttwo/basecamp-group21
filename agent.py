...
EXTRA_TOOLS: List[Dict[str, Any]] = [    # ✏️ Build 2, step 2.1: schemas for the tools you add
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "origin": {"type": "string", "description": "Departure airport, three-letter IATA code, e.g. DEN."},
                "dest": {"type": "string", "description": "Arrival airport, three-letter IATA code, e.g. BOI."},
                "date": {"type": "string", "description": "The disrupted travel date in ISO format, YYYY-MM-DD. The search starts here and looks forward, never backward."},
                "cabin": {"type": "string", "enum": ["Y", "J"], "description": "Cabin to search: Y for main, J for first. Use the cabin the customer is already ticketed in. Defaults to Y."},
            },
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "section": {"type": "string", "description": "Which section to read. A number like '6', or words from its title like 'fare families', 'when we delay', 'care while you wait', 'chat automation'."},
            },
            "required": ["section"],
        },
    },
...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "call this tool after the customer chooses to rebook (not refund) "
                "once check_policy has confirmed rebooking is available, passing the PNR. Return alternative flights"
                ),
            "input_schema": {
                "type": "object",
